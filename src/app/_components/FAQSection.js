    ...
    const faqs = [
        {
            ...
            answer: "Lorem ipsum is simply dummy text of the printing and typesetting industry sapien fermen drana inthe miss molestie non tempor fermen the varius vestibulum drana."
        },
        {
            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col lg:flex-row items-start gap-12">
                    <div className="w-full lg:w-5/12">
                        <span className="text-sm uppercase tracking-wider text-primary mb-4 inline-block">Popular Questions</span>
                        ...
                        <p className="text-dark/70 mb-6 leading-relaxed">
                            The experience elementum sesue in the miss aucantion alesun in sapien fermen the miss caleustion in the sapien.
                        </p>
                        ...
                        <ul className="space-y-4">
                            {faqs.map((faq, index) => (
                                <li key={index} className="border border-gray-200 rounded-lg overflow-hidden">
                                    ...
                                    <div
                                        className={`acc-content transition-all duration-300 ${activeIndex === index ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'
                                            }`}
                                    >
